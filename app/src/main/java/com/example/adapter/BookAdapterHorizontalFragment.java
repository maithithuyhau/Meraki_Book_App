...
public class BookAdapterHorizontalFragment extends RecyclerView.Adapter<BookAdapterHorizontalFragment.MyViewHolder> {

    List<Book> data;
    BookItemClickListener bookItemClickListener;
    public BookAdapterHorizontalFragment( List<Book> data ,BookItemClickListener listener) {
